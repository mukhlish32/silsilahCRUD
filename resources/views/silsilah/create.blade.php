...
<main>
    <div class="container-fluid px-4">
        ...
        <div class="card mb-4">
            ...
            <form method="POST" enctype="multipart/form-data" action="{{ route('silsilah.store') }}">
                @csrf
                <div class="card-body pb-5">
                    <div>
                        ...
                        <input name="txt_nama" type="" placeholder="" value="" class="form-control">
                    </div>
                    <div class="row">
                        <div class="col">
                            <div>
                        ...
                        <div class="col">
                            <div>
                                <label>Anak Ke</label>
                                <input name="txt_anakke" type="" placeholder="" value="" class="form-control">
                            </div>
                        </div>
                    </div>
                </div>
